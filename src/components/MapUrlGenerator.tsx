...
const MapUrlGenerator: React.FC<MapUrlGeneratorProps> = ({ coordinates }) => {
  if (coordinates.length === 0) {
    return (
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-md flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-yellow-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ width: '1rem', height: '1rem', display: 'inline-block', verticalAlign: 'middle' }}>
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
        </svg>
        <span className="text-yellow-700">No coordinates available to generate map URLs.</span>
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="p-4 border-b border-gray-100 bg-gray-50 rounded-t-lg flex items-center">
            <svg className="h-4 w-4 text-red-500 mr-2" viewBox="0 0 24 24" fill="currentColor" style={{ width: '1rem', height: '1rem', display: 'inline-block', verticalAlign: 'middle' }}>
          ...
          <div className="p-4">
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                className="bg-gray-100 hover:bg-gray-200 text-gray-700 py-2 px-3 rounded-md text-sm font-medium"
                title="Copy URL"
              >
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-200">
          <div className="p-4 border-b border-gray-100 bg-gray-50 rounded-t-lg flex items-center">
            <svg className="h-4 w-4 text-blue-500 mr-2" viewBox="0 0 24 24" fill="currentColor" style={{ width: '1rem', height: '1rem', display: 'inline-block', verticalAlign: 'middle' }}>
